...
Entity &Scene::createSettingsOverlay(int windowWidth, int windowHeight) {
    ...
    SDL_Texture *overlayTex = TextureManager::load("../asset/ui/settings.png");
...
void Scene::createSettingUIComponents(Entity &overlay) {
    ...
    auto& closeTransform = closeButton.addComponent<Transform>(Vector2D(baseX + overlaySprite.dst.w - 40, baseY + o), 0.0f, 1.0f);
